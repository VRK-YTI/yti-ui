...
import AdministrativeDetailsExpander, { hasAdministrativeDetails } from './administrative-details-expander';
import DiagramsAndSourcesExpander, { hasDiagramsAndSources } from './diagrams-and-sources-expander';
import OtherDetailsExpander, { hasOtherDetails } from './other-details-expander';
...
export default function DetailsExpander({ concept }: DetailsExpanderProps) {
  ...
  const noAdministrativeDetails = ! hasAdministrativeDetails(concept, i18n.language);
