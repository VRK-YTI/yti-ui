// FIXME: Push runOutsideAngular fix to upstream
...
import { VisNetworkService } from 'ng2-vis/components';
 ...
 */
@Directive({
  selector: '[visNetworkPatched]',
})
export class VisNetworkPatchedDirective implements OnInit, OnDestroy, OnChanges {
   ...
   * @memberOf VisNetworkDirective
   */
  public constructor(private elementRef: ElementRef, private visNetworkService: VisNetworkService, private zone: NgZone) {
