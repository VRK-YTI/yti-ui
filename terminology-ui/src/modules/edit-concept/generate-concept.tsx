    ...
    .map(
      (term) =>
        ({
          ...
          termFamily: term.termFamily || undefined,
          termConjugation: term.termConjugation || undefined,
          termEquivalency: term.termEquivalency || undefined,
          wordClass: term.wordClass || undefined,
