...
export default function SchemaCollection({
  schemaId,
  collectionId,
}: CollectionProps) {
  ...
  // get the schema collection from the server
  ...
  if (collectionError) {
    return (
      <>
        <Breadcrumb>
          {!terminologyError && (
            <BreadcrumbLink url={`/schema/${schemaId}`}>
        ...
        <main id="main">
          <Notification
            ...
            status="error"
            onCloseButtonClick={() =>
              router.push(!terminologyError ? `/terminology/${schemaId}` : '/')
            }
          >
            <Paragraph>
              <Text smallScreen>
  ...
  return (
    <>
      <Breadcrumb>
        {!terminologyError && (
          <BreadcrumbLink url={`/terminology/${schemaId}`}>
            <PropertyValue property={terminology?.properties.prefLabel} />
          </BreadcrumbLink>
        )}
        <BreadcrumbLink
          url={`/terminology/${schemaId}/collections/${collectionId}`}
          current
        >
