  ...
  edges: [
    {
      ...
      id: 'reactflow__edge-is-spouse-person-#corner-2',
      referenceType: 'ASSOCIATION',
      type: 'generalEdge',
      markerEnd: undefined,
      data: { offsetSource: 3, origin: 'is-spouse' },
    },
    {
      source: 'person',
      sourceHandle: 'person',
      ...
      id: 'reactflow__edge-is-address-person-address',
      referenceType: 'ASSOCIATION',
      type: 'generalEdge',
      markerEnd: {
        type: 'arrowclosed',
    ...
    },
    {
      ...
      id: 'reactflow__edge-person-name-#corner-3',
      referenceType: 'ATTRIBUTE_DOMAIN',
      type: 'generalEdge',
      markerEnd: undefined,
      data: { origin: 'name' },
    },
    {
      ...
      id: 'reactflow__edge-person-natural-person-#corner-1',
      referenceType: 'PARENT_CLASS',
      type: 'generalEdge',
      markerEnd: undefined,
    ...
    },
    {
      ...
      id: 'reactflow__edge-corner-1-#corner-1-#corner-4',
      referenceType: 'PARENT_CLASS',
      type: 'generalEdge',
      markerEnd: undefined,
      data: { origin: 'natural-person' },
    ...
    },
    {
      ...
      id: 'reactflow__edge-corner-2-#corner-2-ext:spouse',
      referenceType: 'ASSOCIATION',
      type: 'generalEdge',
      markerEnd: {
        type: 'arrowclosed',
    ...
    },
    {
      ...
      target: 'person',
      targetHandle: 'person',
      id: 'reactflow__edge-corner-3-#corner-3-person',
      referenceType: 'ATTRIBUTE_DOMAIN',
      type: 'generalEdge',
      markerEnd: {
        type: 'arrowclosed',
      ...
      data: { identifier: 'name', origin: 'name' },
    },
    {
      source: '#corner-4',
      ...
      target: 'person',
      targetHandle: 'person',
      id: 'reactflow__edge-corner-4-#corner-4-person',
      referenceType: 'PARENT_CLASS',
      type: 'generalEdge',
      markerEnd: 'clearArrow',
      data: { identifier: 'natural-person', origin: 'natural-person' },
      style: { strokeDasharray: '4 2', stroke: '#235A9A' },
    },
  ],
  loopNodes: [],
...
export const expectedProfileEdges = {
  edges: [
    ...
    },
    {
      ...
      target: '#corner-2',
      targetHandle: '#corner-2',
      id: 'reactflow__edge-is-address-natural-person-#corner-2',
      referenceType: 'ASSOCIATION',
      type: 'generalEdge',
      markerEnd: undefined,
      data: { offsetSource: 3, applicationProfile: true, origin: 'is-address' },
    },
    {
      source: 'natural-person',
      sourceHandle: 'natural-person',
    ...
    },
    {
      ...
      target: 'person',
      targetHandle: 'person',
      id: 'reactflow__edge-corner-1-#corner-1-person',
      referenceType: 'PARENT_CLASS',
      type: 'generalEdge',
      markerEnd: 'clearArrow',
      data: {
    ...
    },
    {
      ...
      target: 'address',
      targetHandle: 'address',
      id: 'reactflow__edge-corner-2-#corner-2-address',
      referenceType: 'ASSOCIATION',
      type: 'generalEdge',
      markerEnd: {
        color: '#212121',
