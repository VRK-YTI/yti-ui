...
export default function NodeMappings(props: {
  ...
  const [mappingPayload, setMappingPayload] = useState<CrosswalkConnectionNew>(
    props.selectedCrosswalk
  );
            ...
            <div className="row bg-white">
              ...
              <div className="col-4">
                <div className="bg-light-blue p-2">
                  ...
                  <p>
                    ...
                    {props.selectedCrosswalk.source.type}
                  </p>
                  <p>
                    <span className="fw-bold">Description: </span>
                    {props.selectedCrosswalk.source?.description
                      ? props.selectedCrosswalk.source?.description
                      : 'N/A'}
                  </p>
              ...
              <div className="col-4">
                <div className="bg-light-blue p-2">
                  ...
                  <p>
                    <span className="fw-bold">Type: </span>
                    {props.selectedCrosswalk.target.type}
                  </p>
                  <p className="mb-1">
                    <span className="fw-bold">Description: </span>
                    {props.selectedCrosswalk.target?.description
                      ? props.selectedCrosswalk.target?.description
                      : 'N/A'}
                  </p>
                  <br />
