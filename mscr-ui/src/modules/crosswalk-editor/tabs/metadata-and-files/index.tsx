...
export default function MetadataAndFiles(props: {
  crosswalks: CrosswalkConnectionNew[];
      ...
      <div className="crosswalk-editor mx-2">
        ...
        <div className="row d-flex justify-content-between metadata-and-files-wrap mx-2">
          <div className="row bg-light-blue">
            <div className="col-6">
              ...
              <div className="my-3">
                PID:<span>{inputValue.pid}</span>
              </div>
              <div className="my-3">
                Version:<span>{inputValue.version}</span>
              </div>
              <div className="my-3">
                {' '}
                Release date:<span>{inputValue.releaseDate}</span>
              </div>
              <div className="my-3">
                Publisher:<span>{inputValue.publisher}</span>
              </div>
              <div className="my-3">
                Creator:<span>{inputValue.creator}</span>
              </div>
              <div className="my-3">
                Contributors:<span>{inputValue.contributors}</span>
              </div>
            </div>
        ...
        <div className="row d-flex justify-content-between metadata-and-files-wrap mx-2">
          <JointListingAccordion
            crosswalkJoints={props.crosswalks}
            viewOnlyMode={true}
            performAccordionAction={null}
          ></JointListingAccordion>
        </div>
      </div>
    </>
