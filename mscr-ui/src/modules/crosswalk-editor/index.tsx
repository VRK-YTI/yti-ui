...
export default function CrosswalkEditor() {
    ...
    const [jointToBeEdited, setJointToBeEdited] = React.useState<CrosswalkConnectionNew>(crosswalkConnectionNewInit);
    ...
    const performCallbackFromMappingModal = (action: any, event: any, crosswalkConnection: any) => {
        ...
        if (action === 'save') {
            setNodeMappingsModalOpen(false);
            setConnectedCrosswalksNew(crosswalkMappings => [jointToBeEdited, ...crosswalkMappings]);
        }
    };
