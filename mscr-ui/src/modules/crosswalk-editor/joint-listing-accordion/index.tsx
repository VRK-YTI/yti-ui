            ...
            <TableContainer component={Paper}>
                <Table aria-label="collapsible table w-100">
                    ...
                    {crosswalkJointsInput?.length < 1 &&
                        <TableBody>
                            <TableRow className=''>
                            <div className='empty-mappings-table'><span className='info-icon'><InfoIcon></InfoIcon></span>No elements have been mapped yet. Mappings will appear in this table.</div>
                            </TableRow>
                            </TableBody>
                    }
                </Table>
