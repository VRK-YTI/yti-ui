...
export default function FixedButtonFooter(props: {
  performFooterActionCallback?: any;
  ...
  return (
    <>
      <div className="fixed-footer">
        <div className="row">
          ...
          <div className="col-4 d-flex flex-row justify-content-end">
            ...
            {isEditModeActive &&
              (props.footerType === FooterTypes.SCHEMA_METADATA ||
                props.footerType === FooterTypes.CROSSWALK_METADATA) && (
                <Sbutton
                  hidden={!isEditModeActive || props.isPublished}
                  onClick={() => {
            ...
            {isEditModeActive &&
              props.footerType === FooterTypes.CROSSWALK_EDITOR &&
              !props.isPublished && (
                <Sbutton
                  variant="secondary"
                  onClick={() => {
      ...
      <ConfirmModal
        ...
        actionText={'Save'}
        cancelText={'Cancel'}
        performConfirmModalAction={performFooterAction}
        heading={'Confirmation'}
        text1={'Do you want to save changes.'}
      />
      <ConfirmModal
        ...
        performConfirmModalAction={performFooterAction}
        heading={'Confirmation'}
        text1={'Do you want to publish the crosswalk.'}
        text2={
          'After publishing, you cannot make changes to mappings in crosswalk.'
        }
      />
    </>
  );
